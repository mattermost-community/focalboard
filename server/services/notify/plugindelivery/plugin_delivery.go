...
// Deliver notifies a user they have been mentioned in a block.
func (pd *PluginDelivery) Deliver(mentionUsername string, extract string, evt notify.BlockChangeEvent) (string, error) {
