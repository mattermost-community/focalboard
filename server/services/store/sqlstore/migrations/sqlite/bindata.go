...
func _000001_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_init.up.sql", size: 308, mode: os.FileMode(0644), modTime: time.Unix(1618643384, 0)}
...
func _000002_system_settings_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000002_system_settings_table.up.sql", size: 107, mode: os.FileMode(0644), modTime: time.Unix(1618643384, 0)}
