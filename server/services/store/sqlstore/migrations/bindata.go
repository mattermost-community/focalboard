...
func _000015_blocks_history_no_nullsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000015_blocks_history_no_nulls.down.sql", size: 214, mode: os.FileMode(436), modTime: time.Unix(1638547648, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000015_blocks_history_no_nullsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000015_blocks_history_no_nulls.up.sql", size: 2438, mode: os.FileMode(436), modTime: time.Unix(1638551689, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
