...
func _000014_subscriptions_tableDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000014_subscriptions_table.down.sql", size: 79, mode: os.FileMode(436), modTime: time.Unix(1633632554, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000014_subscriptions_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000014_subscriptions_table.up.sql", size: 617, mode: os.FileMode(436), modTime: time.Unix(1634057659, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
