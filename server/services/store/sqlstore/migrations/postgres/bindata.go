...
func _000008_teamsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000008_teams.up.sql", size: 114, mode: os.FileMode(420), modTime: time.Unix(1616175775, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
