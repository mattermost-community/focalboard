...
func (m *MockServicesAPI) DeletePreferencesForUser(arg0 string, arg1 []model.Preference) error {
	m.ctrl.T.Helper()
...
func (m *MockServicesAPI) GetPreferencesForUser(arg0 string) ([]model.Preference, error) {
	m.ctrl.T.Helper()
...
func (m *MockServicesAPI) UpdatePreferencesForUser(arg0 string, arg1 []model.Preference) error {
	m.ctrl.T.Helper()
