# Karmaboard Changelog

Karmaboard is an open source, self-hosted alternative to Trello, Notion, Asana and Jira for project management. We help individuals and teams define, organize, track and manage their work.

This changelog summarizes updates to our open source project. You can also find the [latest releases and release notes on GitHub here](https://github.com/mattermost/karmaboard/releases).
...
* Karmaboard can now be built as a Mattermost plugin! Thanks @mgdelacroix and @jespino!
...
* Key Updates:
  * Karmaboard now available on DockerHub at https://hub.docker.com/r/mattermost/karmaboard. [#91](https://github.com/mattermost/karmaboard/issues/91) Thanks @jwilander @obbardc!
  * You can now contribute translations to Karmaboard on https://translate.mattermost.com/. Thanks @jespino!
  ...
  * Add Dockerfile to run service in a container. [#76](https://github.com/mattermost/karmaboard/pull/76) Thanks @proffalken!
  * Add docker-compose to run the whole service in containers. [#105](https://github.com/mattermost/karmaboard/pull/105) Thanks @jbutler992!
  * Added Gallery view.
  * Added Checkbox content type.
  * Added Selected cards duplication with Ctrl+D.
  * Added Search shortcut (Ctrl+Shift+F).
* Requested Contributions
  * Add more frontend unit test coverage. [#126](https://github.com/mattermost/karmaboard/pull/126) Thanks @renjithgr!
  * [GH-40](https://github.com/mattermost/karmaboard/issues/40) - Add property type email [#84](https://github.com/mattermost/karmaboard/pull/84). Thanks @renjithgr!

## v0.6.1 Release - March 15, 2021

* Karmaboard Personal Desktop is now live in the App Stores:
...
* Added [Windows native app (WPF)](https://github.com/mattermost/karmaboard/tree/main/win-wpf) support
* Added [Swagger / OpenAPI definition and documentation](https://htmlpreview.github.io/?https://github.com/mattermost/karmaboard/blob/main/server/swagger/docs/html/index.html)
* Added [Import scripts for Trello, Asana, and Notion](https://github.com/mattermost/karmaboard/tree/main/import)
* Added [Developer Tips and Tricks article](https://www.karmaboard.com/contribute/getting-started/dev-tips/).
* Added Security improvements:
	* [Single-user session token](https://github.com/mattermost/karmaboard/commit/0fe96ad7ed3b0c3a68c9a5889b34b764782f9266)
	* [CSRF prevention with X-Requested-With header](https://github.com/mattermost/karmaboard/commit/43c656c9a440e12f87b61d66654ed3d9873b1620)
