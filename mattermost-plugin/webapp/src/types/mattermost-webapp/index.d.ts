...
export interface PluginRegistry {
    ...
    registerProduct(baseURL: string, switcherIcon: string, switcherText: string, switcherLinkURL: string, mainComponent: React.ElementType, headerCentreComponent: React.ElementType, headerRightComponent?: React.ElementType, showTeamSidebar: boolean, teamSwitchCallback?: (teamID: string) => void, getCurrentTeam?: () => null | (() => string))
