...
describe('Create and delete board / card', () => {
    ...
    beforeEach(() => {
        ...
        expect(localStorage.getItem('focalboardSessionId')).to.eq('TESTTOKEN')
    ...
    it('Can rename the board view', () => {
        ...
        cy.get(`.ViewHeader .Editable[title='${boardViewTitle}']`).should(
            'exist',
        )
    })
    ...
    it('Can rename the table view', () => {
        ...
        cy.get(`.ViewHeader .Editable[title='${tableViewTitle}']`).should(
            'exist',
        )
    })
