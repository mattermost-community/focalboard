                        ...
                        {!props.readonly &&
                            <MenuWrapper>
                                ...
                                <PropertyMenu
                                    ...
                                    onTypeAndNameChanged={(newType: PropertyType = propertyTemplate.type, newName: string = propertyTemplate.name) => mutator.changePropertyTypeAndName(boardTree, propertyTemplate, newType, newName)}
