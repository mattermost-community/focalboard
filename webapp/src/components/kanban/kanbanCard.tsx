...
const KanbanCard = (props: Props) => {
    ...
    const className = props.isSelected ? 'KanbanCard selected' : 'KanbanCard'
    ...
    return (
        <>
            ...
            >
                {
                    props.isManualSort && isOver && !isDragging &&
                    <div className='pseudoDragPlaceholder'/>
                }

                <div className='kanbanCardInnerWrapper'>
                    {!props.readonly &&
                        <MenuWrapper
