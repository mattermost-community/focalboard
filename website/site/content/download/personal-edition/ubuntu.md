...
Download the Ubuntu archive package from the appropriate [release in GitHub](https://github.com/mattermost/focalboard/releases). The example below uses the link for **v7.4.4**, but you're encouraged to use the latest version in the release list:

```
wget https://github.com/mattermost/focalboard/releases/download/v7.4.4/focalboard-server-linux-amd64.tar.gz
